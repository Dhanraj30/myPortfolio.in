...
export const projects = [
  ...
  },
  {
    ...
    link: "https://custom-swap.vercel.app/",
  },
  {
    id: 3,
    title: "Crypto Liquidity Marketplace With ICO (DeFi Project)",
    des: "Decentralized Uniswap ERC20 liquidity marketplace with an integrated ERC20 token sale (Initial Coin Offering or ICO). Users will be able to create liquidity pools for any two tokens and discover liquidity pool addresses across various blockchains.",
    img: "/p3.png",
    iconLists: ["/next.svg", "/tail.svg", "/js.svg", "/sol.svg", "/ethereum.svg"],
    link: "https://liquidity-marketplace-alpha.vercel.app/",
  },
  {
    id: 4,
    title: "Block.Ai (AI bot)",
    des: "Devloped ai integrated decentralized bot help in devlopemt, combining ai and Blockchain, smart contracts..",
    img: "",
    iconLists: ["/next.svg", "/tail.svg", "/js.svg", "/sol.svg", "/ethereum.svg"],
    link: "",
  },
